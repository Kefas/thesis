...
Ruby on Rails udostępnia bogate wsparcie dla interfejsu restowego. Jeżeli zachowane są wzorce nazewnictwa i struktury katalogów, wtedy w myśl zasady \quotes{convention over configuration} nie jest wymagana żadna dodatkowa konfiguracja aplikacji lub serwera.\\
